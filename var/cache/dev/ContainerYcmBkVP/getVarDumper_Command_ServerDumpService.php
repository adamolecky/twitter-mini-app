...
class getVarDumper_Command_ServerDumpService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->pushHandler(($container->privates['monolog.handler.syslog_handler'] ?? $container->getMonolog_Handler_SyslogHandlerService()));
        $a->pushHandler(($container->privates['monolog.handler.file_log'] ?? $container->getMonolog_Handler_FileLogService()));
